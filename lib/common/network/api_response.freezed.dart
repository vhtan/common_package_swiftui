...
abstract class $ApiResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({ErrorCode? code, int? responseTime, dynamic detail});
}
...
class _$ApiResponseImpl implements _ApiResponse {
  _$ApiResponseImpl({this.code, this.responseTime, this.detail});
  ...
  @override
  String toString() {
    return 'ApiResponse(code: $code, responseTime: $responseTime, detail: $detail)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, code, responseTime,
...
abstract class _ApiResponse implements ApiResponse {
  factory _ApiResponse(
      {final ErrorCode? code,
      final int? responseTime,
      final dynamic detail}) = _$ApiResponseImpl;
